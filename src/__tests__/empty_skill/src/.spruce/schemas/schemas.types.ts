...
export declare namespace SpruceSchemas.Local.v2020_09_03 {
	...
	export interface ITestSchemaSchema extends SpruceSchema.ISchema {
		id: 'testSchema',
		name: 'Test Schema',
		    fields: {
		            /** First Field. */
	...
	export type TestSchemaEntity = SchemaEntity<SpruceSchemas.Local.v2020_09_03.ITestSchemaSchema>
